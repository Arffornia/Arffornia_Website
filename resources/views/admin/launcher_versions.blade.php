                    ...
                    <div>
                        <form action="{{ route('launcherVersions.upload') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="overlay__entries">
                                ...
                                <x-inputText01 id="launcher_version" name="launcher_version"
                                    placeholder="📜 Launcher version" value="{{ old('launcher_version') }}"></x-inputText01>
                ...
                <div class="item">
                    <div class="content">
                        ...
                        <div class="in_prod">in prod: <input type="checkbox" onclick="return false;"
                                {{ $launcherVersion->in_prod ? 'checked' : '' }} /></div>
