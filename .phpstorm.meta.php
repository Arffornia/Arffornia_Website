...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.azure.oauth.client.id' => 'string',
            'app.azure.oauth.client.secret' => 'string',
            'app.azure.oauth.redirect_uri' => 'string',
            ...
            'filesystems.links./home/brian/Documents/arffornia/Arffornia_Website/public/storage' => 'string',
...
'app.aliases.Vite','app.azure.oauth.client.id','app.azure.oauth.client.secret','app.azure.oauth.redirect_uri','auth.defaults.guard',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/brian/Documents/arffornia/Arffornia_Website/public/storage','logging.default',
...
'concurrency.default','view.paths','view.compiled','flare.key','flare.flare_middleware',
...
'sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','adminPanel',
'launcherVersions','launcherVersions.upload','launcherImages','launcherImages.upload',);
        registerArgumentsSet('views', 
'admin.admin_panel','admin.launcher_images','admin.launcher_versions','admin.layout','components.flash-message',
'components.inputButton01','components.inputCheckbox01','components.inputFile01','components.inputPassword01','components.inputSubmit01',
'components.inputText01','layout','pages.home','pages.news.allNews','pages.news.news',
'pages.reglement','pages.shop','pages.stages','pages.users.auth','pages.users.login',
'pages.users.profile','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'VITE_APP_NAME','AZURE_OAUTH_CLIENT_ID','AZURE_OAUTH_CLIENT_SECRET','AZURE_OAUTH_REDIRECT_URI','PUSHER_APP_ID',
'PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_HOST','PUSHER_PORT','PUSHER_SCHEME',
'PUSHER_APP_CLUSTER','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET','REVERB_HOST',
