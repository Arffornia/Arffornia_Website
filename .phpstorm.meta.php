...
'filesystems.links./home/brian/Documents/arffornia/Arffornia_Website/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'signed','throttle','verified','anyRole','allRole',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','shop.buy','login','adminPanel','launcherImages',
'launcherImages.upload',);
        registerArgumentsSet('views', 
'admin.admin_panel','admin.launcher_images','admin.layout','components.dropDownBtn','components.flash-message',
'components.gridSection','components.inputButton01','components.inputCheckbox01','components.inputFile01','components.inputPassword01',
'components.inputSubmit01','components.inputText01','components.presentationSection','components.technoSection','layout',
'pages.home','pages.news.allNews','pages.news.news','pages.reglement','pages.shop',
'pages.stages','pages.users.auth','pages.users.login','pages.users.profile','laravel-exceptions-renderer::components.card',
...
'APP_URL','SANCTUM_STATEFUL_DOMAINS','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','AZURE_OAUTH_CLIENT_ID','AZURE_OAUTH_CLIENT_SECRET','AZURE_OAUTH_REDIRECT_URI',
'PUSHER_APP_ID','PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_HOST','PUSHER_PORT',
'PUSHER_SCHEME','PUSHER_APP_CLUSTER','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET',
